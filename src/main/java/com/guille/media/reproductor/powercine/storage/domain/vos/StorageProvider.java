 ...
 *
 * <p>Este enum pertenece al dominio y abstrae al negocio de detalles concretos
 * de infraestructura. El resto de la aplicación no necesita conocer SDKs ni APIs
...
public enum StorageProvider {
     ...
     *
     * <p>Esto es útil porque varios proveedores (por ejemplo MinIO y R2)
     * permiten reutilizar el mismo adaptador basado en el SDK de AWS.
     *
     * @return {@code true} si el proveedor puede utilizar un adaptador S3-compatible.
     */
